...
const env = {
  ...
  ORBIT_INTERNAL_SERVICE_TOKEN: "image-smoke-internal-token-not-production",
  ORBIT_WORKER_COMMAND_TOKEN: "image-smoke-worker-token-not-production",
  PUBLIC_BASE_URL: "http://127.0.0.1:8787", INTERNAL_BASE_URL: "http://127.0.0.1:8787",
  ORBIT_BASE_URL: "http://127.0.0.1:8787", EDGE_GATEWAY_URL: "http://127.0.0.1:8787",
  ...
  ORBIT_ENABLE_LIVE_WS: target === "realtime" ? "true" : "false",
  ORBIT_DISABLE_BACKGROUND_SERVICES: "0", ORBIT_ENABLE_RUNTIME_BACKGROUND_TASKS: "1",
