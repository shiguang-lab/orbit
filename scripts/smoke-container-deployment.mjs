...
try {
  ...
  const native = docker(containers.edge, ["node", "-e", [
    "const Database=require('/app/packages/gateway-runtime/node_modules/better-sqlite3');",
    ...
    "const vec=require('/app/packages/gateway-runtime/node_modules/sqlite-vec'); vec.load(db);",
  ...
  const artifactProbe = JSON.parse(docker(containers.edge, [
    "node",
    "--import", "/app/packages/gateway-runtime/node_modules/tsx/dist/loader.mjs",
    "--input-type=module",
    "-e",
    [
      "import { writeCallArtifactAsync } from './packages/gateway-runtime/src/lib/usage/callLogArtifactWriter.ts';",
