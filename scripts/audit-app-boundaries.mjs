...
const allowedCoreDomainSubpaths = {
  ...
  "apps/worker": ["startup", "worker/"],
  "apps/control-api": ["startup", "runtime/request", "domain/degradation", "db/ping", "db/call-log-stats", "db/provider-connections", "db/provider-stats", "catalog/provider-metadata", "catalog/provider-registry", "pricing/db", "pricing/defaults", "pricing/sync", "pricing/provider-prefixes", "pricing/validation", "cache/db", "cache/services", "db/compression-analytics", "analytics/auto-routing-db", "analytics/diversity", "db-backups/db", "db-backups/validation", "metrics/combo", "metrics/request-telemetry", "metrics/tool-latency", "shared/numeric", "open-sse/utils/error.ts", "control/management-auth", "control/gateway-status", "control/authenticated", "control/synced-models", "control/provider-nodes-route", "control/provider-node-by-id-route", "control/provider-models-route", "control/provider-nodes-validate-route", "control/keys-by-id-route", "control/key-devices-route", "control/key-regenerate-route", "control/key-reveal-route", "control/key-usage-limits-route", "control/key-groups-route", "control/key-group-by-id-route", "control/key-group-keys-route", "control/key-group-permissions-route", "control/settings", "control/api-key-store", "control/cloud-sync", "control/api-key-exposure", "shared/", "sse/logger", "evals/db", "evals/runner", "evals/runtime", "evals/validation", "db/api-keys", "plugins/db", "plugins/manager", "plugins/marketplace", "shared/cors", "quota/schemas", "quota/db", "quota/services", "compliance"],
  "apps/edge-gateway": [
    "startup",
    "runtime/request",
    "edge/audio-speech-handler",
    "edge/audio-translation-handler",
    "edge/image-edits-handler",
    "edge/image-generations-handler",
    "edge/image-upscale-handler",
    "edge/files-root-handler",
    "edge/files-by-id-handler",
    "edge/files-content-handler",
    "edge/batches-root-handler",
    "edge/batches-by-id-handler",
    "edge/batches-cancel-handler",
    "edge/batches-delete-completed-handler",
    ...
    "edge/request-id",
    "edge/audio-provider-nodes",
    "edge/local-db",
    "edge/audio-transcription-handler",
