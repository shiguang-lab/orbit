...
import { jsonSha256 } from "../../../packages/inference/src/utils/jsonHash.ts";
import { jsonLength } from "../../../packages/inference/src/utils/jsonSize.ts";
import { applyLiveZoneCompression } from "../../../packages/inference/src/services/compression/liveZone.ts";
import { applyHardBudget } from "../../../packages/inference/src/services/compression/hardBudget.ts";
import { applyThinkingBudget, ThinkingMode } from "../../../packages/inference/src/services/thinkingBudget.ts";
import { estimateCompressionTokens } from "../../../packages/inference/src/services/compression/stats.ts";
import { createStructuredSSECollector } from "../../../packages/inference/src/utils/streamPayloadCollector.ts";
import type { CompressionResult } from "../../../packages/inference/src/services/compression/types.ts";
import { adaptBodyForCompression } from "../../../packages/inference/src/services/compression/bodyAdapter.ts";
import { codexResponsesEngine } from "../../../packages/inference/src/services/compression/engines/codexResponses/index.ts";
import { registerProviderRuntimePorts } from "../../../packages/core/src/runtime/providerRuntimePorts.ts";
...
registerProviderRuntimePorts({
  ...
  resolveCanonicalProviderModel: (provider, model) => ({ provider: provider ?? null, model: model ?? null }),
  getLearnedThinkingCap: () => null,
