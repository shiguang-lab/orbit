...
import { applyCompression } from "../../../packages/inference/src/services/compression/strategySelector.ts";
import {
  makeMemoKey,
  memoStore,
  clearMemoStore,
  getMemoStats,
} from "../../../packages/inference/src/services/compression/resultMemo.ts";
