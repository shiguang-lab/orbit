...
// local `droid` CLI. Orbit already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through Orbit.
//
...
// back to stored CLI credentials only when omitted. Orbit does NOT read
