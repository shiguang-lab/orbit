...
- sebelum akun aktif habis, ShiguangGateway menghasilkan ringkasan terstruktur yang ringkas
- setelah autentikasi memilih akun berbeda untuk sesi yang sama, ShiguangGateway menyuntikkan
...
Jika penyedia aktif diaktifkan di `handoffProviders`, ShiguangGateway menghasilkan ringkasan handoff
...
ShiguangGateway menambahkan handoff yang tersimpan sebagai pesan sistem. Penyuntikan hanya terjadi setelah
...
Pada saat penyuntikan, ShiguangGateway mengonversi muatan tersebut menjadi pesan sistem `<context_handoff>`
