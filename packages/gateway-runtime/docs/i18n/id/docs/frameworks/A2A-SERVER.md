# Dokumentasi Server A2A ShiguangGateway (Bahasa Indonesia)
...
> Protokol Agent-to-Agent v0.3 — ShiguangGateway sebagai agen routing cerdas
...
Mengembalikan Kartu Agen yang mendeskripsikan kemampuan, keterampilan, dan persyaratan autentikasi ShiguangGateway.
...
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Merutekan prompt melalui pipeline cerdas ShiguangGateway. Mengembalikan respons beserta penjelasan routing, biaya, dan jejak ketahanan.                        |
