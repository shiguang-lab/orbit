...
<sub>📖 Setup 34 tools → [`docs/reference/CLI-TOOLS.md`](../../reference/CLI-TOOLS.md) · OpenCode plugin → [`@shiguang-gateway/opencode-provider`](https://www.npmjs.com/package/@shiguang-gateway/opencode-provider)</sub>
...
| 🧩 **OpenCode plugin**    | `@shiguang-gateway/opencode-provider`           | Нативная интеграция            |
