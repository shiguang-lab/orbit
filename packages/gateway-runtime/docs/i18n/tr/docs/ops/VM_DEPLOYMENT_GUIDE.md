---
title: "ShiguangGateway — Cloudflare ile VM Üzerinde Dağıtım Kılavuzu"
version: 3.8.50
lastUpdated: 2026-08-23
---

# ShiguangGateway — Cloudflare ile VM Üzerinde Dağıtım Kılavuzu (Türkçe)
...
Cloudflare üzerinden yönetilen bir alan adı ile VM (VPS) üzerinde ShiguangGateway kurulumu ve yapılandırması için eksiksiz kılavuz.
...
## 2. ShiguangGateway Kurulumu

```bash
mkdir -p /opt/shiguang-gateway
cd /opt/shiguang-gateway
```

Docker Compose ile ShiguangGateway'u başlatın:
