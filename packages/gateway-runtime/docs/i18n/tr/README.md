...
<sub>📖 34 aracın tümü için araç bazında kurulum (26 CLI Kodlama + 8 CLI Ajanı) → [`docs/reference/CLI-TOOLS.md`](docs/reference/CLI-TOOLS.md) · 🧩 OpenCode eklentisi → [`@shiguang-gateway/opencode-provider`](https://www.npmjs.com/package/@shiguang-gateway/opencode-provider)</sub>
...
<table>
  ...
  <tr><td align="left" nowrap>🧩 <b>OpenCode eklentisi</b></td><td align="left" nowrap><code>@shiguang-gateway/opencode-provider</code></td><td align="left">Yerel OpenCode entegrasyonu</td></tr>
