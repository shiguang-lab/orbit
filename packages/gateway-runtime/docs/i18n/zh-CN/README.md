...
<sub>📖 16+ 款工具的逐项配置指南 → [`docs/reference/CLI-TOOLS.md`](../../reference/CLI-TOOLS.md) · 🧩 OpenCode 插件 → [`@shiguang-gateway/opencode-provider`](https://www.npmjs.com/package/@shiguang-gateway/opencode-provider)</sub>
...
| 🧩 **OpenCode 插件**     | `@shiguang-gateway/opencode-provider`           | 原生 OpenCode 集成                                |
