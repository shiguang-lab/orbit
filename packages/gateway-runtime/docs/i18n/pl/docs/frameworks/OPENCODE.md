...
> **Źródło prawdy (pakiet npm):** `@shiguang-gateway/opencode-provider/` (publikowalny workspace)
...
## Ścieżka 2 — pakiet npm `@shiguang-gateway/opencode-provider`
...
Pełne API znajdziesz w [README pakietu](../../@shiguang-gateway/opencode-provider/README.md).
...
- Źródło: `src/shared/services/opencodeConfig.ts`, `src/lib/cli-helper/config-generator/opencode.ts`, `@shiguang-gateway/opencode-provider/src/index.ts`
