...
├── @shiguang-gateway/           # Publikowalne pakiety towarzyszące (opencode-plugin, opencode-provider)
...
Osobny workspace npm (`@shiguang-gateway/open-sse`). Obsługuje przetwarzanie żądań + wykonanie u providerów.
