...
<sub>📖 Konfiguracja per narzędzie dla wszystkich 33 narzędzi (25 z CLI Code + 8 z CLI Agents) → [`docs/reference/CLI-TOOLS.md`](docs/reference/CLI-TOOLS.md) · 🧩 Wtyczka OpenCode → [`@shiguang-gateway/opencode-provider`](https://www.npmjs.com/package/@shiguang-gateway/opencode-provider)</sub>
...
| 🧩 **Wtyczka OpenCode**   | `@shiguang-gateway/opencode-provider`           | Natywna integracja z OpenCode                                                 |
