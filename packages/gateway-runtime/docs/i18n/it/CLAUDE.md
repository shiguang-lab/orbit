...
- **Importazioni**: esterne → interne (`@/`, `@shiguang-gateway/open-sse`) → relative
...
- **Alias di percorso**: `@/*` → `src/`, `@shiguang-gateway/open-sse` → `open-sse/`, `@shiguang-gateway/open-sse/*` → `open-sse/*`
