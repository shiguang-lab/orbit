 ...
 * overrides"), adapted to ShiguangGateway's alias storage shape (`src/lib/db/models/mitmAlias.ts`,
 ...
 */
import { normalizeEffort, type CanonicalEffort } from "../shared/reasoning/effortStandardization.ts";
