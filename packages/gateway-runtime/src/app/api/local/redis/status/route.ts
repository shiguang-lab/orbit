...
const CONTAINER_NAME = process.env.SHIGUANG_GATEWAY_REDIS_CONTAINER_NAME || "shiguangGateway-redis";
const HOST_PORT = process.env.SHIGUANG_GATEWAY_REDIS_HOST_PORT || "6379";
...
export async function GET() {
  ...
  // Native Redis via REDIS_URL (the production path this instance uses). ShiguangGateway
