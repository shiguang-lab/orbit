...
export const REDIS_CONTAINER_NAME = process.env.SHIGUANG_GATEWAY_REDIS_CONTAINER_NAME || "shiguangGateway-redis";
...
// SHIGUANG_GATEWAY_REDIS_BIND_HOST and secure the instance themselves.
