...
import { getDbInstance, SQLITE_FILE } from "../../../../lib/db/core.ts";
import { exportAllSummaryRows } from "../../../../lib/db/backup.ts";
import { CALL_LOGS_DIR } from "../../../../lib/usage/callLogArtifacts.ts";
import fs from "fs";
    ...
    try {
      ...
      return new NextResponse(archiveBuffer, {
        ...
        headers: {
          ...
          "Content-Disposition": `attachment; filename="shiguangGateway-full-backup-${timestamp}.tar.gz"`,
