...
const OPENAPI_SPEC_CANDIDATES = [
  ...
  // Independent Fastify deployments execute this route from the repository
  // root, while the canonical contract lives inside the local runtime package.
  path.join(process.cwd(), "packages", "gateway-runtime", "docs", "openapi.yaml"),
  path.join(path.dirname(fileURLToPath(import.meta.url)), "../../../../../docs/openapi.yaml"),
];
