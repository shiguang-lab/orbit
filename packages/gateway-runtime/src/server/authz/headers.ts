...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-shiguangGateway-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-shiguangGateway-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-shiguangGateway-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-shiguangGateway-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-shiguangGateway-auth-scopes";
 ...
 * token matches this process's SHIGUANG_GATEWAY_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-shiguangGateway-peer-ip";
 ...
 * proxy hop (e.g. ShiguangGateway behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-shiguangGateway-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-shiguangGateway-peer-locality";
 ...
 */
export const AUTHZ_HEADER_TRUSTED_PEER_IP = "x-shiguangGateway-trusted-peer-ip";
