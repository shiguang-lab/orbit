...
import type { GoogleLoopbackHint } from "../../lib/oauth/utils/googleLoopbackHint.ts";
import type { PkceLoopbackMismatchHint } from "../../lib/oauth/utils/pkceLoopbackWarning.ts";
    ...
    <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-3 space-y-3">
      ...
      <p className="text-xs text-text-muted">
        {t.rich("googleLoopbackHeadlessAlt", {
          a: (chunks) => (
            <a
              href="https://github.com/shiguang-lab/shiguang-gateway#oauth-on-a-remote-server"
              target="_blank"
              rel="noreferrer"
              className="underline"
            >
