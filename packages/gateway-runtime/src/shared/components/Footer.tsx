...
const PROJECT_REPO = "https://github.com/shiguang-lab/shiguang-gateway";
...
const footerLinks = {
  ...
  resources: [
    ...
    {
      key: "helpCenter",
      href: `${PROJECT_REPO}/discussions`,
      external: true,
    },
  ],
  company: [
    { key: "about", href: PROJECT_REPO, external: true },
    { key: "blog", href: `${PROJECT_REPO}/releases`, external: true },
    {
      key: "contact",
      href: `${PROJECT_REPO}/issues/new/choose`,
      external: true,
    },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm text-text-muted">
            ...
            <a
              href={`${PROJECT_REPO}/blob/main/LICENSE`}
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors"
            >
