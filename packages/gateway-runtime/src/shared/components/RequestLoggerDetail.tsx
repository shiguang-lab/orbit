...
import { formatDuration, formatApiKeyLabel, maskAccount } from "../utils/formatting.ts";
import { formatErrorForDisplay } from "../utils/formatting.ts";
import {
  PayloadSection,
  ConversationContextSection,
} from "./RequestLoggerDetail.sections.tsx";
...
function getCodexAccountRotation(detail) {
  ...
  for (const source of sources) {
    const meta = source?._shiguangGateway;
