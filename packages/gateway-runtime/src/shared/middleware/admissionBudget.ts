 ...
 * the hot path. `override` defaults to `SHIGUANG_GATEWAY_CHAT_MAX_INFLIGHT_BYTES`.
 */
export function resolveIngestByteBudget(
  override: string | number | null | undefined = process.env.SHIGUANG_GATEWAY_CHAT_MAX_INFLIGHT_BYTES
): IngestBudget {
