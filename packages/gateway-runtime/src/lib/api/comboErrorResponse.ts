 ...
 * messages. See `plans/2026-06-23-shiguangGateway-v3.8.34-deep-audit.md` (Bug #3).
 *
 * Usage:
...
import { ERROR_CODES } from "../../shared/constants/errorCodes.ts";
import {
  attachRequestIdToResponse,
  getRequestId,
} from "../../shared/utils/requestId.ts";
