...
declare global {
  var __shiguangGatewayApiBridgeStarted: boolean | undefined;
}
...
export function initApiBridgeServer(): void {
  ...
  installProcessCrashGuard();
  if (globalThis.__shiguangGatewayApiBridgeStarted) return;
  ...
  server.listen(apiPort, host, () => {
    globalThis.__shiguangGatewayApiBridgeStarted = true;
