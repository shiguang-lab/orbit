...
description: Synchronise ShiguangGateway configuration, provider connections, and settings to/from cloud storage. Manage cloud worker authentication and remote backup targets.
---
...
Authenticates with the ShiguangGateway cloud worker for remote access.
