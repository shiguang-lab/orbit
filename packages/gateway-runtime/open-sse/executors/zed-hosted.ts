 ...
 * to OpenAI Chat Completions chunks by reusing ShiguangGateway's own translators
 ...
 * adapted to TypeScript + ShiguangGateway's BaseExecutor/translator conventions.
    ...
    const response = await zedLlmFetch(zedCredentials, "/completions", {
      ...
      fetchOptions: {
        ...
        headers: {
          ...
          "User-Agent": `ShiguangGateway/zed-hosted`,
          "x-zed-version":
