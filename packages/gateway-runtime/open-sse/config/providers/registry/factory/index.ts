...
// local `droid` CLI. ShiguangGateway already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through ShiguangGateway.
//
...
// back to stored CLI credentials only when omitted. ShiguangGateway does NOT read
