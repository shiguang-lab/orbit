 ...
 * The tag is an internal ShiguangGateway marker; providers must never see it or their
...
export function applyComboAgentMiddleware(
  ...
  //    These tags are ShiguangGateway-internal markers and must never reach the provider
