...
const DEFAULT_TIMEOUT_MS =
  Number.parseInt(process.env.SHIGUANG_GATEWAY_NOTION_TLS_TIMEOUT_MS || "", 10) || 30_000;
const HARD_TIMEOUT_GRACE_MS =
  Number.parseInt(process.env.SHIGUANG_GATEWAY_NOTION_TLS_GRACE_MS || "", 10) || 10_000;
