 ...
 * Override with `SHIGUANG_GATEWAY_MAX_NONSTREAMING_RESPONSE_BYTES`.
 */
export const MAX_NONSTREAMING_RESPONSE_BYTES = (() => {
  const parsed = Number.parseInt(String(process.env.SHIGUANG_GATEWAY_MAX_NONSTREAMING_RESPONSE_BYTES), 10);
