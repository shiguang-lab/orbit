...
export const TABLE_OWNERSHIP: readonly TableRef[] = [
  ...
  { table: GATEWAY_TABLES.groupModelPermissions, owner: "control-api", access: "read-write" },
  { table: GATEWAY_TABLES.keyGroupMembers, owner: "control-api", access: "read-write" },
  ...
  { table: GATEWAY_TABLES.discoveryResults, owner: "control-api", access: "read-write" },
