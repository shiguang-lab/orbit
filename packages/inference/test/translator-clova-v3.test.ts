...
const request = await import("../src/translator/request/openai-to-clova.ts");
const response: any = await import("../src/translator/response/clova-to-openai.ts");
const registry = await import("../src/translator/registry.ts");
const { FORMATS } = await import("../src/translator/formats.ts");
const { getExecutor } = await import("../src/executors/index.ts");
