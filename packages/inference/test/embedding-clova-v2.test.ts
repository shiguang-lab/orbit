...
const registry = await import("../src/config/embeddingRegistry.ts");
const { normalizeClovaEmbeddingV2Response } =
  await import("../src/handlers/embeddingStructuredInput.ts");
const { handleEmbedding } = await import("../src/handlers/embeddings.ts");
const { resetDbInstance } = await import("../../core/src/lib/db/core.ts");
