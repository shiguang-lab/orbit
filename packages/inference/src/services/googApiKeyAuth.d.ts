import { type AuthRequestHeaders } from "./headerReader.ts";
/**
 ...
 */
export declare function extractGoogApiKeyHeader(headers: AuthRequestHeaders | null | undefined): string | null;
