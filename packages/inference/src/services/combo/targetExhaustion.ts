...
import { isCloudflareFingerprintRejection } from "@orbit/core/domain/provider-error-classifier";
...
import { isAgentrouterConnectionQuotaScope } from "../auth.ts";
...
/**
 * #1731v2: connection-level errors (408/5xx, excluding the ShiguangGateway circuit-open signal) suggest
