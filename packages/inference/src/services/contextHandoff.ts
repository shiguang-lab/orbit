...
export function resolveUniversalHandoffConfig(
  ...
  return {
    ...
    relayMode: getString("relayMode", "standard") === "schema-locked" ? "schema-locked" : "standard",
  };
}
...
export function selectMessagesForSummary(
  ...
  maxMessages: number,
  relayMode: "schema-locked" | "standard" = "standard"
): MessageLike[] {
