...
export function isMcpDescriptionCompressionEnabled(
  ...
  if (isDisabledEnvValue(process.env.ORBIT_MCP_COMPRESS_DESCRIPTIONS)) return false;
  if (isDisabledEnvValue(process.env.ORBIT_MCP_DESCRIPTION_COMPRESSION)) return false;
