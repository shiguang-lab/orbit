...
export const githubSkillTools = {
  orbit_github_skills_search: {
    name: "orbit_github_skills_search",
    description:
  ...
  orbit_github_skills_scan: {
    name: "orbit_github_skills_scan",
    description:
  ...
  orbit_github_skills_install: {
    name: "orbit_github_skills_install",
    description:
