...
export const gamificationTools: McpToolDefinition[] = [
  {
    ...
    handler: async (args: { scope: string; limit: number }) => {
      const { getTopN } = await import("@orbit/core/edge/mcp-gamification");
  ...
  },
  {
    ...
    handler: async (args: { apiKeyId: string; scope: string }) => {
      const { getRank } = await import("@orbit/core/edge/mcp-gamification");
  ...
  },
  {
    ...
    handler: async (args: { apiKeyId: string }) => {
      const { getXp, getBadges } = await import("@orbit/core/gamification/profile");
      const { calculateLevel, getLevelTitle, getLevelTier } =
        await import("@orbit/core/edge/mcp-gamification");
      const { getStreak } = await import("@orbit/core/edge/mcp-gamification");
  ...
  },
  {
    ...
    handler: async (args: { apiKeyId?: string; category?: string }) => {
      const { getBadgeDefinitions, getBadges } = await import("@orbit/core/gamification/profile");
  ...
  },
  {
    ...
    handler: async (args: {
      ...
      const { transferTokens } = await import("@orbit/core/edge/mcp-gamification");
  ...
  },
  {
    ...
    handler: async (args: { apiKeyId: string; serverUrl?: string; maxUses: number }) => {
      const { createInvite } = await import("@orbit/core/edge/mcp-gamification");
  ...
  },
  {
    ...
    inputSchema: z.object({}),
    handler: async () => {
      const { listServers } = await import("@orbit/core/edge/mcp-gamification");
  ...
  },
  {
    ...
    inputSchema: z.object({}),
    handler: async () => {
      const { getAnomalies } = await import("@orbit/core/edge/mcp-gamification");
