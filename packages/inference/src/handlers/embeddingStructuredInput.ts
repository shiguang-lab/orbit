import { MAX_EMBEDDING_INLINE_TOTAL_BYTES } from "@orbit/core/edge/embedding-input-limits";
import type { EmbeddingMultimodalItem } from "@orbit/core/edge/embedding-input-limits";
