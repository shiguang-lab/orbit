...
import type { AutoVariant } from "../services/autoCombo/autoPrefix.ts";
import {
...
import {
  ...
  type AutoCategory,
  type AutoTier,
} from "../services/autoCombo/suffixComposition.ts";
import {
  isValidModelFamily,
  type ModelFamily,
...
async function applyAutoPrefix(
  ...
  try {
    const { parseAutoPrefix } =
      await import("../services/autoCombo/autoPrefix.ts");
