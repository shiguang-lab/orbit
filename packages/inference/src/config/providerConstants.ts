 ...
 * not reach into core source files (which would create a dependency
 * cycle: core itself depends on open-sse).
 */
...
// small execution-facing map locally instead of importing core data.
