...
} from "../../config/antigravityUpstream.js";
import {
  GITHUB_COPILOT_API_VERSION,
  GITHUB_COPILOT_CHAT_PLUGIN_VERSION,
  GITHUB_COPILOT_CHAT_USER_AGENT,
  GITHUB_COPILOT_EDITOR_VERSION,
} from "../../config/providerHeaderProfiles.js";
import {
  GROK_BUILD_DEVICE_CODE_URL,
  GROK_BUILD_OAUTH_ISSUER,
  GROK_BUILD_OAUTH_SCOPES,
  GROK_BUILD_TOKEN_URL,
} from "../../config/grokBuild.js";
import { resolvePublicCred } from "../../utils/publicCreds.js";
import { CURSOR_AGENT_CLI_VERSION } from "../../utils/cursorAgentCliVersion.js";
import { buildGitLabOAuthEndpoints, GITLAB_DUO_DEFAULT_BASE_URL } from "@orbit/core/control/oauth-gitlab";
import {
...
// flowType in ../providers/trae.ts and wire endpoints below.
