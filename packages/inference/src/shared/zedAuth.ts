 ...
 *
 *   1. The client (Orbit) generates an ephemeral RSA keypair.
 ...
 *   5. Orbit decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + Orbit conventions. `fetch` is intentionally the
