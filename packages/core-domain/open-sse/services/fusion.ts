 ...
 * wired through ShiguangGateway's existing combo schema (combo.config.judgeModel /
...
export const FUSION_DEFAULTS = {
  ...
  // with the runtime heap capped (Dockerfile SHIGUANG_GATEWAY_MEMORY_MB, default
