...
import { HIDEABLE_SIDEBAR_GROUP_IDS } from "../constants/sidebarGroupVisibility.ts";
import { HIDEABLE_SIDEBAR_ITEM_IDS, SIDEBAR_SECTIONS } from "../constants/sidebarVisibility.ts";
import { ACCOUNT_FALLBACK_STRATEGY_VALUES } from "../constants/routingStrategies.ts";
import { RESPONSES_PREVIOUS_RESPONSE_ID_MODES } from "../constants/responsesPreviousResponseId.ts";
import {
  VIDEO_BRIDGE_TIMEOUT_MAX_MS,
  VIDEO_BRIDGE_TIMEOUT_MIN_MS,
} from "../constants/modalityBridgeDefaults.ts";
...
const transformInjectBillingHeaderSchema = z.object({
  ...
  versionFormat: z.enum(["ex-machina", "shiguangGateway-daystamp"]),
