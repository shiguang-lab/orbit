 ...
 *
 * On failure, `response` is a fully-prepared Web `Response` (with the standard
...
export type ValidatedJsonBodyResult<TData> =
  { success: true; data: TData } | { success: false; response: Response };
 ...
 * return 400 `Response` on failure. Both the malformed-JSON and the failed-
