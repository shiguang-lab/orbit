...
import { isCredentialBlob, submitCredentialBlob } from "./oauthBlobSubmit.ts";
import {
  looksLikeCodexSessionJson,
  parseCodexSessionJson,
} from "../../lib/oauth/utils/codexSessionImport.ts";
import GheConfigStep from "./oauthModal/GheConfigStep.tsx";
import GitlabDuoSetupStep from "./oauthModal/GitlabDuoSetupStep.tsx";
import OAuthErrorStep from "./oauthModal/OAuthErrorStep.tsx";
import OAuthWaitingStep from "./oauthModal/OAuthWaitingStep.tsx";
import { parseGrokCliPasteToken } from "../../lib/oauth/utils/grokCliAuthJson.ts";
import { buildGoogleLoopbackHint } from "../../lib/oauth/utils/googleLoopbackHint.ts";
import {
  buildPkceLoopbackMismatchHint,
  type PkceLoopbackMismatchHint,
} from "../../lib/oauth/utils/pkceLoopbackWarning.ts";
  ...
  const startOAuthFlow = useCallback(
    async (opts?: { grokBrowser?: boolean }) => {
      ...
      try {
        ...
        // show an auth code instead of redirecting back to ShiguangGateway.
        ...
        //   NEXT_PUBLIC_BASE_URL or SHIGUANG_GATEWAY_PUBLIC_BASE_URL are configured.
        ...
        if (provider === "codex" || provider === "openai") {
          ...
          // Behind reverse proxy: use actual origin (e.g., https://shiguangGateway.example.com/callback)
