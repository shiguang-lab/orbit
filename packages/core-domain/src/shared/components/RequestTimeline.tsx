...
import RequestLoggerDetail from "./RequestLoggerDetail.tsx";
...
import {
  ...
  truncateModel,
  formatDateLabel,
} from "./RequestTimeline.utils.ts";

export type { TimelineLog } from "./RequestTimeline.utils.ts";
export { allocateLanes } from "./RequestTimeline.utils.ts";
