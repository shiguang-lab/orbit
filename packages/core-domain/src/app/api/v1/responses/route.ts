...
import { resolveResponsesApiModel } from "../../internal/codex-responses-ws/modelResolution.ts";
import { getModelInfo, getComboForModel } from "../../../../sse/services/model.ts";
 ...
 * without this rewrite ShiguangGateway routes it to openrouter instead of codex.
 *
