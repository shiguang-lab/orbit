...
import { getApiKeys, createApiKey, pickApiKeyForInternalUse, updateSettings } from "../../../../lib/localDb.ts";
import { getConsistentMachineId } from "../../../../shared/utils/machineId.ts";
import { syncToCloud, fetchWithTimeout, CLOUD_URL } from "../../../../lib/cloudSync.ts";
...
export async function GET() {
  try {
    const { isCloudEnabled } = await import("../../../../lib/db/settings.ts");
