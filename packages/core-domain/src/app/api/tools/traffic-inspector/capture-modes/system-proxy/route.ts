...
import { InspectorSystemProxyActionSchema } from "../../../../../../shared/schemas/inspector.ts";
import { apply, revert } from "../../../../../../mitm/inspector/systemProxyConfig.ts";
import {
  getSystemProxyState,
  setSystemProxyApplied,
  clearSystemProxy,
} from "../../../../../../lib/inspector/captureState.ts";
