 ...
 */
import { z } from "zod";
import { installCertResult, uninstallCert, checkCertInstalled } from "../../../../../mitm/cert/install.ts";
 ...
 *
 * ShiguangGateway keeps the CA installed across normal stop/start to avoid repeated
