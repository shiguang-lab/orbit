...
import { processCopilotChat } from "../../../../lib/copilot/engine.ts";
 ...
 *
 * ShiguangGateway Copilot chat endpoint.
 * Accepts user messages about ShiguangGateway configuration and returns
