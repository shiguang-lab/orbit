...
import {
  ...
  PROJECT_ROOT,
} from "../../../../lib/system/autoUpdate.ts";
import { NEWS_JSON_URL, parseActiveNewsPayload } from "../../../../shared/utils/releaseNotes.ts";
import {
  clearLatestVersionCache,
  isNewer,
  resolveLatestVersionCached,
} from "../../../../lib/system/versionCheck.ts";
import { resolveGlobalShiguangGatewayPath } from "../../../../lib/system/globalPackagePath.ts";
import { restartRunningServer } from "../../../../lib/system/processManagerRestart.ts";
...
import { buildNpmExecOptions, SERVICE_VERSION_PATTERN } from "../../../../lib/services/installers/utils.ts";
