...
import { classifyIpScope } from "../../../../lib/ipUtils.ts";
...
import { loginSchema } from "../../../../shared/validation/schemas.ts";
import { isValidationFailure, validateBody } from "../../../../shared/validation/helpers.ts";
import { checkLoginGuard, clearLoginAttempts, recordLoginFailure } from "../../../../server/auth/loginGuard.ts";
import { AUTHZ_HEADER_TRUSTED_PEER_IP } from "../../../../server/authz/headers.ts";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const trustedPeerIp = process.env.SHIGUANG_GATEWAY_PEER_STAMP_TOKEN
