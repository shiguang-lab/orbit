 ...
 *
 * Serves the ShiguangGateway A2A Agent Card in the A2A Protocol v1.0 shape for
 ...
 *
 * Returns the ShiguangGateway Agent Card (A2A v1.0).
 */
  ...
  const agentCard = {
    ...
    skills: [
      ...
      },
      {
        ...
        description: "Returns the full catalog of ShiguangGateway agent skills.",
