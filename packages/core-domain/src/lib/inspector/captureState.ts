...
import type { HttpProxyServerHandle } from "../../mitm/inspector/httpProxyServer.ts";
import type { PreviousState } from "../../mitm/inspector/systemProxyConfig.ts";
...
export function setSystemProxyApplied(
  ...
  guardTimer = setTimeout(
    () => {
      ...
      import("../../mitm/inspector/systemProxyConfig.ts").then(({ revert }) => {
