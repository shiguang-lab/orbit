...
import { testSingleConnection } from "../../app/api/providers/[id]/test/route.ts";
import { getProviderConnections } from "../localDb.ts";
import {
  setCredentialHealth,
...
import { SEARCH_VALIDATOR_CONFIGS } from "../providers/validation/searchProviders.ts";
...
async function testConnection(
  ...
  try {
    const { getCredentialHealth } = await import("./cache.ts");
