...
let providersModulePromise: Promise<typeof import("../db/providers.ts")> | null = null;
function loadProvidersModule(): Promise<typeof import("../db/providers.ts")> {
  if (!providersModulePromise) {
    providersModulePromise = import("../db/providers.ts");
  }
