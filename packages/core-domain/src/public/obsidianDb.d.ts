export declare function getObsidianToken(): string | null;
export declare function setObsidianToken(token: string): void;
export declare function clearObsidianToken(): void;
