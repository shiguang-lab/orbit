...
} from "@shiguang-gateway/open-sse/services/compression/engines/registry";
...
`@shiguang-gateway/open-sse/services/compression/strategySelector`):

```ts
import { applyStackedCompression } from "@shiguang-gateway/open-sse/services/compression/strategySelector";
