...
- **Importaciones**: externo → interno (`@/`, `@shiguang-gateway/open-sse`) → relativo
...
- **Alias de ruta**: `@/*` → `src/`, `@shiguang-gateway/open-sse` → `open-sse/`, `@shiguang-gateway/open-sse/*` → `open-sse/*`
