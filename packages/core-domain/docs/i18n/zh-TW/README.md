...
<sub>📖 所有 33 個工具的個別設定 → [`docs/reference/CLI-TOOLS.md`](../../reference/CLI-TOOLS.md) · 🧩 OpenCode 插件 → [`@shiguang-gateway/opencode-provider`](https://www.npmjs.com/package/@shiguang-gateway/opencode-provider)</sub>
...
| 🧩 **OpenCode 插件**     | `@shiguang-gateway/opencode-provider`               | 原生 OpenCode 整合                              |
...
| [MCP Server](../../open-sse/mcp-server/README.md)  | 107 個 MCP 工具、IDE 設定、Python/TS/Go 客戶端 |
