...
├── @shiguang-gateway/           # Publishable companion packages (opencode-plugin, opencode-provider)
...
Separate npm workspace (`@shiguang-gateway/open-sse`). Handles request processing + provider execution.
