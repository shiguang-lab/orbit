...
test("network/probe-origin exposes the complete narrow probe context contract", async () => {
  const entry = manifest.exports["./network/probe-origin"];
  assert.deepEqual(entry, {
    types: "./src/public/networkProbeOrigin.d.ts",
    import: "./src/network/probeOrigin.ts",
  });
...
test("scenario-specific probe-origin aliases stay retired", () => {
