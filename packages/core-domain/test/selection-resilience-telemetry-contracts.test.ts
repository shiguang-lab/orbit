...
const contracts = {
  "./selection/shuffle-deck": {
    entry: "./src/selection/shuffleDeck.ts",
    runtime: [
      "fisherYatesShuffle",
      "getNextFromDeck",
      "getNextFromDeckSync",
  ...
  "./resilience/rate-limit-classification": {
    entry: "./src/resilience/rateLimitClassification.ts",
    runtime: ["classify429FromError", "looksLikeQuotaExhausted"],
  },
  "./metrics/request-telemetry": {
    entry: "./src/metrics/requestTelemetry.ts",
    runtime: ["RequestTelemetry", "getTelemetrySummary", "recordTelemetry"],
  },
} as const;
...
const retiredDeclarations = ["classify429.d.ts", "requestTelemetry.d.ts"] as const;
...
test("layer-specific selection, classification, and telemetry aliases stay retired", () => {
