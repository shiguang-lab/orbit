...
} from "@shiguang-gateway/core-domain/runtime/peak-hour-protection";
import { buildJinaEnvCredentials } from "@shiguang-gateway/core-domain/runtime/jina-credentials";
import { buildGeminiEnvCredentials } from "@shiguang-gateway/core-domain/runtime/gemini-credentials";
 ...
 * - `Authorization: Bearer <key>` (OpenAI / ShiguangGateway / Codex CLI / Bearer clients)
 ...
 * rejected by per-route gates that compare against ShiguangGateway keys.
 *
