...
export const githubSkillTools = {
  shiguangGateway_github_skills_search: {
    name: "shiguangGateway_github_skills_search",
    description:
  ...
  shiguangGateway_github_skills_scan: {
    name: "shiguangGateway_github_skills_scan",
    description:
  ...
  shiguangGateway_github_skills_install: {
    name: "shiguangGateway_github_skills_install",
    description:
