...
import { applyReasoningRuleDirective } from "../../core-domain/src/lib/reasoningRouting/policy.ts";
import { getModelPreserveVideoUrl } from "../../core-domain/src/lib/db/models/modelPreserveVideoUrl.ts";
...
export function translateRequest(
  ...
  // itself rejects it with "Unknown parameter: '_shiguangGatewayResponsesStore'".
