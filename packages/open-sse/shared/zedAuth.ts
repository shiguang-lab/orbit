 ...
 *
 *   1. The client (ShiguangGateway) generates an ephemeral RSA keypair.
 ...
 *   5. ShiguangGateway decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + ShiguangGateway conventions. `fetch` is intentionally the
