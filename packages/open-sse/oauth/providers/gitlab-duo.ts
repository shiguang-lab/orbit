import { GITLAB_DUO_CONFIG } from "../constants/oauth.js";
import { buildGitLabOAuthEndpoints, parseGitLabDirectAccessDetails } from "@shiguang-gateway/core-domain/control/oauth-gitlab";
