...
`@orbit/core` provides shared domain and persistence capabilities
...
- Shared contracts and schema definitions belong in `@orbit/contracts`
  or `@orbit/contracts/db-schema`; environment/config primitives belong in
  `@orbit/config`.
