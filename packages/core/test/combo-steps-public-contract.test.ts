...
test("routing/combo-steps exposes the focused combo step contract", async () => {
  const entry = manifest.exports["./routing/combo-steps"];
  assert.deepEqual(entry, {
    types: "./src/public/routingComboSteps.d.ts",
    import: "./src/routing/comboSteps.ts",
  });
...
test("scenario-specific combo step aliases stay retired", () => {
