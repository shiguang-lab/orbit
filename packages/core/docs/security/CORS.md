...
(`apps/gateway/src/cloud-agents/domain/api.ts`, `getCloudAgentCorsHeaders`) and **do** emit
...
| Cloud-Agent per-route CORS (the exception)      | `apps/gateway/src/cloud-agents/domain/api.ts`                                          |
