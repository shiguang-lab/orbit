...
> மேலும் ஒரு செழுமையான பிளக்கின் ஒருங்கிணைப்பு உள்ளது — `shiguang-gateway setup opencode` — இது `@orbit/opencode-plugin` ஐ நிறுவுகிறது. அவை வெவ்வேறு கட்டளைகள்; மேலே உள்ள அட்டவணை `setup-opencode` ஐ ஆவணமாக்குகிறது.
