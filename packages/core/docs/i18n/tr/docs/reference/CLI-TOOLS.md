---
title: "CLI Araçları — Orbit"
version: 3.8.50
lastUpdated: 2026-08-23
---

# CLI Araçları — Orbit (Türkçe)
...
Orbit, üç özel pano sayfasına yayılmış üç CLI araçları kategorisiyle entegre olur:

| Sayfa          | Rota                    | Konsept                                                                    | Sayı         |
| -------------- | ----------------------- | -------------------------------------------------------------------------- | ------------ |
| **CLI Code's** | `/dashboard/cli-code`   | Orbit'a yönlendirdiğiniz kodlama araçları (İstemci → CLI → Orbit → Sağlayıcı) | 26           |
| **CLI Ajanları**| `/dashboard/cli-agents` | Orbit'a yönlendirdiğiniz özerk ajanlar (aynı akış, daha geniş kapsam)  | 8            |
| **ACP Ajanları**| `/dashboard/acp-agents` | Orbit'un stdio/ACP ile başlattığı CLI'lar (ters başlatma akışı)       | bkz. kayıt   |
...
Claude / Codex / OpenCode / Cline / KiloCode / Continue / Hermes / Goose / ...
           │
           ▼  (hepsi Orbit'a yönlendirilir)
    http://SUNUCUNUZ:20128/v1
           │
           ▼  (Orbit doğru sağlayıcıya yönlendirir)
