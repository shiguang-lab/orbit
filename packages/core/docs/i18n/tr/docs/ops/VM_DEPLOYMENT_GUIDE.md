---
title: "Orbit — Cloudflare ile VM Üzerinde Dağıtım Kılavuzu"
version: 3.8.50
lastUpdated: 2026-08-23
---

# Orbit — Cloudflare ile VM Üzerinde Dağıtım Kılavuzu (Türkçe)
...
Cloudflare üzerinden yönetilen bir alan adı ile VM (VPS) üzerinde Orbit kurulumu ve yapılandırması için eksiksiz kılavuz.
...
Docker Compose ile Orbit'u başlatın:
