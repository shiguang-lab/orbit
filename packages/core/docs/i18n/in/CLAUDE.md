...
**Orbit** — proxy/router AI terpadu. Satu endpoint, 329 penyedia LLM, auto-fallback.
...
Orbit memiliki tiga mekanisme kegagalan sementara yang terkait tetapi berbeda. Jaga agar ruang lingkup mereka terpisah saat melakukan debugging perilaku pengalihan. Lihat diagram
...
- **Direktori data**: variabel lingkungan `DATA_DIR`, default ke `~/.orbit/`
