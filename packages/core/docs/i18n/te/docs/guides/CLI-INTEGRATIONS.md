...
> ఒక సమృద్ధి కలిగిన ప్లగిన్ ఇంటిగ్రేషన్ కూడా ఉంది — `shiguang-gateway setup opencode` — ఇది `@orbit/opencode-plugin` ను ఇన్‌స్టాల్ చేస్తుంది. ఇవి వేరు వేరు కమాండ్లు; పై పట్టిక `setup-opencode` ను డాక్యుమెంట్ చేస్తుంది.
