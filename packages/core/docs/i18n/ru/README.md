...
<sub>📖 Setup 34 tools → [`docs/reference/CLI-TOOLS.md`](../../reference/CLI-TOOLS.md) · OpenCode plugin → [`@orbit/opencode-provider`](https://www.npmjs.com/package/@orbit/opencode-provider)</sub>
