...
>
> Kanoniczna lista kategorii i schemat per kategoria znajdują się w [`open-sse/services/compression/rules/_schema.json`](../../inference/services/compression/rules/_schema.json) (JSON Schema draft 2020-12).
