...
} from "@orbit/inference/services/compression/engines/registry";
...
`@orbit/inference/services/compression/strategySelector`):

```ts
import { applyStackedCompression } from "@orbit/inference/services/compression/strategySelector";
