...
├── open-sse/             Workspace silnika streamingu (@orbit/inference)
...
Osobny npm workspace publikowany jako `@orbit/inference`. Odpowiada za
...
- **Importy**: external → internal (`@/`, `@orbit/inference`) → relative.
