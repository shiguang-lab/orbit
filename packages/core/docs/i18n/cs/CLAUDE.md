...
**Orbit** — jednotný AI proxy/router. Jeden koncový bod, 329 poskytovatelů LLM, automatické zálohování.
...
Orbit má tři související, ale odlišné mechanismy dočasného selhání. Udržujte jejich rozsah oddělený při ladění chování routování. Viz
...
- **Adresář dat**: `DATA_DIR` env var, výchozí hodnota `~/.orbit/`
