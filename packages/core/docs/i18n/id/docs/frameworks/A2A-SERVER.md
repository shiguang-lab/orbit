# Dokumentasi Server A2A Orbit (Bahasa Indonesia)
...
> Protokol Agent-to-Agent v0.3 — Orbit sebagai agen routing cerdas
...
Mengembalikan Kartu Agen yang mendeskripsikan kemampuan, keterampilan, dan persyaratan autentikasi Orbit.
...
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Merutekan prompt melalui pipeline cerdas Orbit. Mengembalikan respons beserta penjelasan routing, biaya, dan jejak ketahanan.                        |
