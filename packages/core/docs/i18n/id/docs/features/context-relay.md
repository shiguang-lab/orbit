...
- sebelum akun aktif habis, Orbit menghasilkan ringkasan terstruktur yang ringkas
- setelah autentikasi memilih akun berbeda untuk sesi yang sama, Orbit menyuntikkan
...
Jika penyedia aktif diaktifkan di `handoffProviders`, Orbit menghasilkan ringkasan handoff
...
Orbit menambahkan handoff yang tersimpan sebagai pesan sistem. Penyuntikan hanya terjadi setelah
...
Pada saat penyuntikan, Orbit mengonversi muatan tersebut menjadi pesan sistem `<context_handoff>`
