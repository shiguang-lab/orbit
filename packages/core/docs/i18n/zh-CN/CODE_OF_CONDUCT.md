...
可通过以下方式向负责执行的社区领导者举报辱骂、骚扰或其他不可接受的行为：在 <https://github.com/diegosouzapw/ShiguangGateway/security/advisories/new> 创建私人安全建议，或发送电子邮件至维护者 diegosouza.pw@outlook.com。
