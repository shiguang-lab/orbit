...
> একটি সমৃদ্ধ প্লাগইন ইন্টিগ্রেশনও রয়েছে — `shiguang-gateway setup opencode` — যা `@orbit/opencode-plugin` ইনস্টল করে। এগুলি ভিন্ন কমান্ড; উপরের টেবিলটি `setup-opencode` ডকুমেন্ট করে।
