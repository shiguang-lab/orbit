...
[Issue #7854](https://github.com/diegosouzapw/ShiguangGateway/issues/7854). The public products are
represented as four provider families. Region is connection data, not a separate product.

## Decision

| Provider family                            | ShiguangGateway ID            | Global region | China region |
| ------------------------------------------ | ----------------------- | ------------- | ------------ |
