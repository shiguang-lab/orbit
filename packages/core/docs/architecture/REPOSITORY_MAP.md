...
| `apps/gateway/src/cloud-agents/`     | Cloud Agents (Codex Cloud, Devin, Jules) — see `docs/frameworks/CLOUD_AGENT.md` |
| `combos/`                                | Shared combo step, invariant, and auto-promotion logic                                                                                                                                                                                                                                                                  |
| `audit/`                                 | High-level audit action allowlist; activity presentation belongs to `apps/console` — see `docs/architecture/MONITORING_SECTIONS.md`                                                                                                                       |
...
Separate npm workspace (`@orbit/inference`). Handles request processing + provider execution.
...
| `cli/{args,data-dir,encryption,io,providers,provider-store,provider-test,settings-store,sqlite}.mjs` | CLI helper modules                                                                                                         |
...
| `apps/control/src/system/runtime/env-sync.ts` | Inspect and append `.env` defaults for source deployments          |
