...
| `apps/edge-gateway/src/cloud-agents/`     | Cloud Agents (Codex Cloud, Devin, Jules) — see `docs/frameworks/CLOUD_AGENT.md` |
| `combos/`                                | Shared combo step, invariant, and auto-promotion logic                                                                                                                                                                                                                                                                  |
| `audit/`                                 | High-level audit action allowlist; activity presentation belongs to `apps/admin` — see `docs/architecture/MONITORING_SECTIONS.md`                                                                                                                       |
