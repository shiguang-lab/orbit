...
> **Canonical schema (source of truth):** [`open-sse/services/compression/rules/_schema.json`](../../inference/services/compression/rules/_schema.json) (JSON Schema draft 2020-12).
