...
} from "../../constants/modelSupportedEndpoints.ts";
...
import { validateProviderSpecificData } from "../providerSpecificData.ts";
import {
  isReservedProviderPrefix,
  reservedProviderPrefixMessage,
} from "../../constants/reservedProviderPrefixes.ts";
...
import { isValidProviderIconUrl } from "../iconUrl.ts";
  ...
  .object({
    ...
    rateLimitOverrides: z
      .object({
        ...
        rpd: rateLimitOverrideNumber(100_000_000).optional(),
