...
// Namespace prefix for all Orbit Redis keys. Prevents key collisions when
// Orbit shares a Redis instance with other apps (e.g. on 127.0.0.1:6379).
const REDIS_KEY_PREFIX = process.env.REDIS_KEY_PREFIX?.trim() || "orbit:";
