...
export const CliCatalogEntrySchema = z.object({
  ...
  defaultModels: z.array(z.object({
    id: z.string(), name: z.string(), alias: z.string(),
    envKey: z.string().optional(), defaultValue: z.string().optional(), isTopLevel: z.boolean().optional(),
  })).optional(),
  guideSteps: z.array(z.object({
    step: z.number().int().positive(), title: z.string(), desc: z.string().optional(),
    value: z.string().optional(), copyable: z.boolean().optional(),
    type: z.enum(["apiKeySelector", "modelSelector"]).optional(),
  })).optional(),
  codeBlock: z.object({ language: z.string(), code: z.string() }).optional(),
  notes: z.array(z.object({
    type: z.enum(["info", "warning", "error", "cloudCheck"]), text: z.string(),
  })).optional(),
