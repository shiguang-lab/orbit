...
import { getUnsupportedParams } from "@orbit/providers/provider-registry";
import { GEMINI_FALLBACK_THINKING_CAP } from "@orbit/contracts/gemini-thinking-budget";
 ...
 * the single shared source (`@orbit/contracts/vision-models`, #4072) so routing,
