 ...
 *
 *   LISTEN 0 511 127.0.0.1:8787 0.0.0.0:* users:(("node",pid=596922,fd=18))
 *
 ...
 *
 *   tcp 0 0 127.0.0.1:8787 0.0.0.0:* LISTEN 596922/node
 *
 ...
 * merely shares a suffix (87 vs 8787) or a foreign address ending in the
