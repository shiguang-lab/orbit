...
export const RENAMED_MIGRATION_COMPATIBILITY = [
  ...
  // Renamed-in-place migrations: the version slot was reused under a new name, so a
  // database that applied the old name must be reconciled against the current file
