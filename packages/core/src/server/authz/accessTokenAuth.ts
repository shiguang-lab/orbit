import { verifyAccessToken } from "../../lib/db/accessTokens.ts";
import { scopeSatisfies, type AccessScope } from "../../lib/accessTokens/scopes.ts";
import { inferRequiredScope } from "./accessScopes.ts";
