...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-orbit-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-orbit-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-orbit-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-orbit-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-orbit-auth-scopes";
 ...
 * token matches this process's ORBIT_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-orbit-peer-ip";
 ...
 * proxy hop (e.g. Orbit behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-orbit-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-orbit-peer-locality";
 ...
 */
export const AUTHZ_HEADER_TRUSTED_PEER_IP = "x-orbit-trusted-peer-ip";
