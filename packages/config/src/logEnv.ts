...
/**
 * Shared server logging configuration.
 *
...
const DEFAULT_CALL_LOG_MAX_ENTRIES = 10_000;
const DEFAULT_CALL_LOGS_TABLE_MAX_ROWS = 100_000;
const DEFAULT_CALL_LOG_PIPELINE_MAX_SIZE_KB = 512;
const DEFAULT_PROXY_LOGS_TABLE_MAX_ROWS = 100_000;
