import { ipVersion, isPrivateHost, normalizeHost } from "@orbit/utils/network/private-host";
...
// Host classification lives in `@orbit/utils/network/private-host`, which this
