...
export const WORKER_JOBS: readonly WorkerJob[] = [
  ...
  { name: "quota-auto-ping", mode: "call", modulePath: domainModule("lib/services/quotaAutoPing"), exportName: "startQuotaAutoPing", stopExportName: "stopQuotaAutoPing" },
  ...
  { name: "warmup", mode: "call", modulePath: domainModule("lib/warmupScheduler"), exportName: "startWarmupScheduler", stopExportName: "stopWarmupScheduler" },
  { name: "provider-limits", mode: "call", modulePath: domainModule("shared/services/providerLimitsSyncScheduler"), exportName: "startProviderLimitsSyncScheduler", stopExportName: "stopProviderLimitsSyncScheduler" },
  ...
  { name: "credential-health", mode: "call", modulePath: domainModule("lib/credentialHealth/scheduler"), exportName: "initCredentialHealthCheck", stopExportName: "stopCredentialHealthCheck" },
  ...
  { name: "reasoning-cache-cleanup", mode: "call", modulePath: domainModule("lib/jobs/reasoningCacheCleanupJob"), exportName: "startReasoningCacheCleanupJob", stopExportName: "stopReasoningCacheCleanupJob" },
  ...
  { name: "proxy-health", mode: "import", modulePath: domainModule("lib/proxyHealth/scheduler"), stopExportName: "stopProxyHealthCheck" },
  { name: "free-proxy-auto-sync", mode: "import", modulePath: domainModule("lib/freeProxyProviders/scheduler"), stopExportName: "stopFreeProxyAutoSync" },
