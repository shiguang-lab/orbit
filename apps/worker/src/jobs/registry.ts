...
export const WORKER_JOBS: readonly WorkerJob[] = [
  ...
  { name: "subscription", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/worker/proxy-subscription-lifecycle"), exportName: "startSubscriptionScheduler", stopExportName: "stopSubscriptionScheduler" },
