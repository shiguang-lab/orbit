...
export const WORKER_JOBS: readonly WorkerJob[] = [
  ...
  { name: "radar-sync", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/radar/sync-lifecycle"), exportName: "initRadarSyncScheduler", stopExportName: "stopRadarSyncScheduler" },
  ...
  { name: "openrouter-provider-stats", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/catalog/openrouter-provider-stats-lifecycle"), exportName: "initOpenRouterProviderStatsSync", stopExportName: "stopOpenRouterProviderStatsSync" },
  ...
  { name: "runtime-config-hot-reload", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/worker/config-hot-reload"), exportName: "startRuntimeConfigHotReload", stopExportName: "stopRuntimeConfigHotReload" },
