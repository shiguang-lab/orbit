...
export const WORKER_JOBS: readonly WorkerJob[] = [
  ...
  { name: "connection-recovery", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/worker/connection-recovery"), exportName: "initConnectionRecoveryScheduler", stopExportName: "stopConnectionRecoveryScheduler" },
  ...
  { name: "session-affinity-cleanup", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/worker/session-affinity"), exportName: "startSessionAccountAffinityCleanup", stopExportName: "stopSessionAccountAffinityCleanupForTests" },
  ...
  { name: "audit-log", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/worker/compliance"), exportName: "initAuditLog" },
  { name: "audit-log-retention", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/worker/compliance"), exportName: "cleanupExpiredLogs" },
