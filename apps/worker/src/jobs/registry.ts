...
export const WORKER_JOBS: readonly WorkerJob[] = [
  ...
  { name: "models-dev-sync", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/worker/model-sync-lifecycle"), exportName: "startPeriodicSync", stopExportName: "stopPeriodicSync" },
  { name: "pricing-sync", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/worker/pricing-sync-lifecycle"), exportName: "startPeriodicSync", stopExportName: "stopPeriodicSync" },
  { name: "cleanup", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/worker/database-cleanup-lifecycle"), exportName: "startCleanupScheduler", stopExportName: "stopCleanupScheduler" },
  ...
  { name: "vacuum-scheduler", mode: "call", loadModule: () => import("@shiguang-gateway/core-domain/worker/database-vacuum-lifecycle"), exportName: "initVacuumScheduler", stopExportName: "stop" },
