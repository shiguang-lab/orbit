 ...
 *
 * Auth model: each Telegram user is mapped to a generated Orbit API key
...
/**
 * Resolve (and lazily mint) an Orbit API key for a Telegram user.
...
/**
 * Proxy one user prompt through the Orbit chat pipeline.
