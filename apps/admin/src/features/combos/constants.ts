...
export function getStepDisplayName(step: import("@omniroute/contracts").ComboStep): string {
...
export function getStepProvider(step: import("@omniroute/contracts").ComboStep): string | undefined {
  if ("providerId" in step && typeof step.providerId === "string") return step.providerId;
  return undefined;
}

export function getStepConnection(step: import("@omniroute/contracts").ComboStep): string | undefined {
