...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    icon: "router",
    items: [
      { key: "endpoints", label: "端点", to: "/dashboard/endpoint", icon: "api" },
      { key: "api-manager", label: "API 密钥管理", to: "/dashboard/api-manager", icon: "vpn_key" },
      { key: "providers", label: "提供者", to: "/dashboard/providers", icon: "dns" },
      { key: "embedded-services", label: "内嵌服务", to: "/dashboard/providers/services", icon: "deployed_code" },
      { key: "combos", label: "组合", to: "/dashboard/combos", icon: "layers" },
      { key: "combos-live", label: "组合工作室", to: "/dashboard/combos/live", icon: "account_tree" },
      { key: "quota", label: "提供者配额", to: "/dashboard/quota", icon: "tune" },
      ...
      { key: "conductor", label: "调度器", to: "/dashboard/conductor", icon: "account_tree" },
      ...
      { key: "discovery", label: "发现", to: "/dashboard/discovery", icon: "travel_explore" },
      { key: "api-endpoints", label: "API 端点", to: "/dashboard/api-endpoints", icon: "api" },
      { key: "webhooks", label: "Webhook", to: "/dashboard/webhooks", icon: "webhook" },
      { key: "proxy", label: "代理", to: "/dashboard/system/proxy", icon: "dns" },
    ],
  },
  {
    key: "analytics",
    ...
    icon: "analytics",
    items: [
      { key: "analytics", label: "用量", to: "/dashboard/analytics", icon: "analytics" },
      { key: "analytics-combo-health", label: "组合健康度", to: "/dashboard/analytics/combo-health", icon: "monitor_heart" },
      { key: "analytics-utilization", label: "利用率", to: "/dashboard/analytics/utilization", icon: "bar_chart" },
      { key: "cache", label: "缓存", to: "/dashboard/cache", icon: "cached" },
      { key: "analytics-compression", label: "压缩", to: "/dashboard/analytics/compression", icon: "compress" },
      { key: "analytics-search", label: "搜索", to: "/dashboard/analytics/search", icon: "manage_search" },
      { key: "analytics-evals", label: "评估", to: "/dashboard/analytics/evals", icon: "labs" },
      { key: "provider-stats", label: "提供者统计", to: "/dashboard/provider-stats", icon: "speed" },
    ],
  },
  {
    key: "costs",
    ...
    icon: "payments",
    items: [
      { key: "costs-pricing", label: "定价", to: "/dashboard/costs/pricing", icon: "price_change" },
      { key: "costs-budget", label: "预算", to: "/dashboard/costs/budget", icon: "savings" },
      { key: "costs-free-tiers", label: "免费额度", to: "/dashboard/free-tiers", icon: "request_quote" },
      { key: "free-provider-rankings", label: "免费提供者排行", to: "/dashboard/free-provider-rankings", icon: "leaderboard" },
      { key: "radar", label: "雷达", to: "/dashboard/radar", icon: "radar" },
    ],
  },
  {
    key: "monitoring",
    ...
    icon: "monitoring",
    items: [
      { key: "activity", label: "活动", to: "/dashboard/activity", icon: "timeline" },
      ...
      { key: "conversations", label: "对话", to: "/dashboard/conversations", icon: "forum" },
      { key: "health", label: "健康状态", to: "/dashboard/health", icon: "health_and_safety" },
      { key: "runtime", label: "运行时", to: "/dashboard/runtime", icon: "bolt" },
      { key: "resilience-connections", label: "弹性连接", to: "/dashboard/resilience/connections", icon: "shield" },
      { key: "audit", label: "审计", to: "/dashboard/audit", icon: "policy" },
  ...
  },
  {
    ...
    icon: "terminal",
    items: [
      { key: "translator", label: "转换器", to: "/dashboard/translator", icon: "translate" },
      { key: "playground", label: "游乐场", to: "/dashboard/playground", icon: "science" },
      { key: "search-tools", label: "搜索工具", to: "/dashboard/search-tools", icon: "manage_search" },
    ],
  },
  {
    key: "capabilities",
    ...
    items: [
      ...
      { key: "memory", label: "记忆", to: "/dashboard/memory", icon: "psychology" },
      { key: "agent-skills", label: "智能体技能", to: "/dashboard/agent-skills", icon: "share" },
      { key: "chaos-config", label: "混沌模式", to: "/dashboard/chaos", icon: "blender" },
      { key: "skills", label: "Omni 技能", to: "/dashboard/omni-skills", icon: "auto_fix_high" },
      { key: "plugins", label: "插件", to: "/dashboard/plugins", icon: "extension" },
    ],
  },
  {
    key: "other-features",
    ...
    icon: "apps",
    items: [
      { key: "leaderboard", label: "排行榜", to: "/dashboard/leaderboard", icon: "emoji_events" },
      { key: "profile", label: "个人资料", to: "/dashboard/profile", icon: "person" },
      { key: "tokens", label: "令牌", to: "/dashboard/tokens", icon: "toll" },
      { key: "media", label: "媒体", to: "/dashboard/cache/media", icon: "perm_media" },
      { key: "batch", label: "批处理", to: "/dashboard/batch", icon: "view_list" },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "settings-modality-bridge", label: "模态桥接", to: "/dashboard/settings/modality-bridge", icon: "image_search" },
  ...
  },
  {
    ...
    icon: "help",
    items: [
      { key: "docs", label: "文档", to: "/docs", icon: "menu_book" },
      { key: "issues", label: "问题反馈", to: "https://github.com/diegosouzapw/OmniRoute/issues", icon: "bug_report" },
      { key: "changelog", label: "更新日志", to: "/dashboard/changelog", icon: "campaign" },
    ],
  },
];
