...
- Canonical CLI locale list: `apps/cli/src/cli/locale-catalog.mjs`.

### Adding a new locale file

1. Add the code to `apps/cli/src/cli/locale-catalog.mjs`.
2. Run `node apps/cli/src/cli/scripts/generate-locales.mjs` — creates `apps/cli/src/cli/locales/{code}.json`.
