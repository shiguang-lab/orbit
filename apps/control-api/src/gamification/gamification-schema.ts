...
/**
 * Tables owned by the control-plane gamification module. The canonical table
 * and column vocabulary lives in packages/db-schema; DDL stays with the app
 * that owns writes and migrations.
 */
const GAMIFICATION_SCHEMA_SQL = `
...
export function ensureGamificationSchema(): void {
  getDbInstance().exec(GAMIFICATION_SCHEMA_SQL);
}
