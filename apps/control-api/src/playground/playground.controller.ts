import { Controller, Delete, Get, Options, Param, Post, Put, Req, Res } from "@nestjs/common";
...
export class PlaygroundController {
  constructor(private readonly routes: WebRouteDispatcher, private readonly playground: PlaygroundService) {}
