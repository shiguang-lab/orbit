...
export class JobsController {
  ...
  @Post(":id/enable") enable(@Param("id") id: string, @Res() reply: FastifyReply) { return this.send(reply, this.service.toggle(id, true)); }
  @Post(":id/disable") disable(@Param("id") id: string, @Res() reply: FastifyReply) { return this.send(reply, this.service.toggle(id, false)); }
