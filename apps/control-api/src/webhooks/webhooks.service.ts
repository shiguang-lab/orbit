...
export class WebhooksService {
  ...
  get(request: Request, id: string) { return getWebhook(request, { params: Promise.resolve({ id }) }); }
  update(request: Request, id: string) { return updateWebhook(request, { params: Promise.resolve({ id }) }); }
  remove(request: Request, id: string) { return removeWebhook(request, { params: Promise.resolve({ id }) }); }
  deliveries(request: Request, id: string) { return getDeliveries(request, { params: Promise.resolve({ id }) }); }
  test(request: Request, id: string) { return testWebhook(request, { params: Promise.resolve({ id }) }); }
}
