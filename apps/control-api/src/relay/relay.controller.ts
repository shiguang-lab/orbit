...
export class RelayController {
  constructor(private readonly service: RelayService, private readonly routes: WebRouteDispatcher) {}
  @Get() list(@Req() q: FastifyRequest, @Res() r: FastifyReply) { return this.routes.dispatch(q, r, (x) => this.service.list(x)); }
