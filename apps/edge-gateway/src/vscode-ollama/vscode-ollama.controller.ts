...
export class VscodeOllamaController {
  ...
  @Get("show") show(@Req() req: FastifyRequest, @Res() reply: FastifyReply, @Param("token") token: string) { return this.routes.dispatch(req, reply, r => this.service.show(r, token), { token }); }
