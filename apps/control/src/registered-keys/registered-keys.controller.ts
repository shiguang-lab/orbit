import { Inject, Controller, Delete, Get, Param, Post, Put, Req, Res } from "@nestjs/common";
...
export class RegisteredKeysController {
  constructor(@Inject(WebRouteDispatcher) private readonly routes: WebRouteDispatcher, @Inject(RegisteredKeysService) private readonly service: RegisteredKeysService) {}
